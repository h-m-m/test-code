...
EOF
  ...
  it "creates any arbitrary square board" do
    @board = SudokuSolver::Board.new(size: 16)
    ...
    @board = SudokuSolver::Board.new(size: 25)
    ...
    proc {SudokuSolver::Board.new(size: 5)}.must_raise ArgumentError
  end
...
EOF
  ...
  it "can provide provide a list of every coordinate" do
    ...
    @found_9x9 = false
    @board.square(*@test_coordinate).value = 8
